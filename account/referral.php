...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <p class="login-box-msg">Register a new membership</p>
      ...
      <div class="form-group has-feedback">
        <input type="password" id="jpc_password2" name="jpc_password2" class="form-control" placeholder="Retype password" onblur="ValidatePassword();" required>
...
<script type="text/javascript">
  ...
  var x=parent.document.URL.substring(parent.document.URL.indexOf('r='), parent.document.URL.length); 
  var y=x.replace('r=', '');
  $("#jpc_sponsorid").val(y);
</script>
</body>
