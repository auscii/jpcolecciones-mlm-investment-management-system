...
<body class="hold-transition register-page"z>
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form id="jpc_formregistration" class="form-horizontal" action="<?php echo $jpc_postlink ; ?>" method="post">
    <p class="login-box-msg">Register a new membership</p>
      <div class="form-group has-feedback">
        <label>Membership Plan</label>
        <select class="form-control select2" id="jpc_membershipplan" name="jpc_membershipplan"  style="width: 100%;">
      ...
      <div class="form-group has-feedback">
        <input type="text" id="jpc_firstname" name="jpc_firstname" class="form-control" placeholder="First Name" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" id="jpc_lastname" name="jpc_lastname" class="form-control" placeholder="Last Name" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" id="jpc_middlename" name="jpc_middlename" class="form-control" placeholder="Middle Name" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" id="jpc_sponsorid" name="jpc_sponsorid" class="form-control" placeholder="Sponsor ID" required>
        <span class="glyphicon glyphicon-list-alt form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="email" id="jpc_email" name="jpc_email" class="form-control" placeholder="Email" required>
      ...
      <div class="form-group has-feedback">
        <input type="password" id="jpc_password2" name="jpc_password2" class="form-control" placeholder="Retype password" required onblur="ValidatePassword();">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input id="jpc_termsandcondition" name="jpc_termsandcondition" type="checkbox" required> I agree to the <a href="jpc_termsandcondition.php">terms</a>
            </label>
          </div>
        </div>
        <!-- /.col -->
    ...
    <a href="<?php echo $jpc_mainlink ; ?>" class="text-center">I already have a membership</a>
  </div>
  <!-- /.form-box -->
  </form>
</div>
...
<script>
  ...
  function ValidatePassword() {
    ...
    var inputjpc_password2 = $("#jpc_password2").val() ;

    if (inputjpc_password!=inputjpc_password2) {
         AlertMessage("Password did not match!")
        return ;
    }
  }
